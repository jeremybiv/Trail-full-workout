...
export const UP: Exercise[] = [
  ...
  { id: 'bicycle',     m: 'twist', desc: 'Coude vers le genou opposé.', level: 2, photo: true, video: '/exercises/bicycle.mp4' },
  { id: 'legraise',    m: 'cdyn',  desc: 'Jambes tendues, montée lente.', level: 1, photo: true },
  { id: 'superman',    m: 'plank', desc: 'Bras et jambes décollés, dos gainé.', level: 1, hold: true, photo: true, video: '/exercises/superman.mp4' },
...
export const LG: Exercise[] = [
  { id: 'squat',      m: 'squat', desc: 'Hanches arrière, talons au sol.', level: 1, photo: true, video: '/exercises/squat.mp4' },
  ...
  { id: 'wallsit',    m: 'plank', desc: 'Dos au mur, cuisses parallèles.', level: 1, hold: true, video: '/exercises/wallsit.mp4' },
  { id: 'jlunge',     m: 'squat', desc: "Alterne en l'air, amorti.", level: 3, photo: true, video: '/exercises/jlunge.mp4' },
  ...
  { id: 'highknee',   m: 'cdyn',  desc: 'Course sur place, genoux à hauteur de hanche.', level: 2, photo: true, video: '/exercises/highknee.mp4' },
  ...
  { id: 'calfstep',   m: 'calf',  desc: 'Talons dans le vide en bord de marche, amplitude complète.', level: 2 },
];
