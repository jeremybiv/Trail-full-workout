...
export const UP: Exercise[] = [
  ...
  { id: 'pike',        m: 'press', desc: 'Fessiers hauts, pompe quasi-verticale.',                   level: 3 },
  { id: 'plank',       m: 'plank', desc: 'Tête-talons alignés, respire lentement.',                  level: 1, hold: true, photo: true },
  { id: 'sideplank',   m: 'plank', desc: 'Avant-bras, hanches hautes.',                              level: 2, hold: true, unilateral: true },
  ...
  { id: 'bicycle',     m: 'twist', desc: 'Coude vers le genou opposé.',                              level: 2 },
  ...
  { id: 'shouldertap', m: 'cdyn',  desc: "Planche, touche l'épaule opposée.",                        level: 1 },
  { id: 'flutter',     m: 'cdyn',  desc: 'Dos au sol, jambes tendues, battements alternatifs.',      level: 1, photo: true },
  { id: 'splitcrunch', m: 'cdyn',  desc: 'Jambes en ciseaux, crunch synchronisé.',                   level: 2 },
  ...
  { id: 'birddog',     m: 'plank', desc: 'Planche, bras et jambe opposés tendus.',                   level: 1 },
];
...
export const LG: Exercise[] = [
  ...
  { id: 'rlunge',     m: 'squat', desc: 'Pas arrière, descente contrôlée.',                          level: 2 },
  { id: 'jumpsquat',  m: 'squat', desc: 'Explosivité, atterrissage souple.',                         level: 3, photo: true },
  { id: 'calf',       m: 'calf',  desc: 'Pointes de pieds, descente lente.',                         level: 1 },
  ...
  { id: 'swingdrive', m: 'cdyn',  desc: 'Montée genou + extension explosive, alterné.',              level: 2 },
  { id: 'pogo',       m: 'calf',  desc: 'Petits bonds rapides, réception sur les pointes.',          level: 3 },
  { id: 'highknee',   m: 'cdyn',  desc: 'Course sur place, genoux à hauteur de hanche.',             level: 2 },
  ...
  { id: 'clamshell',  m: 'squat', desc: 'Sur une jambe, ouvre la hanche en rotation externe.',       level: 1, unilateral: true },
  { id: 'janefonda',  m: 'squat', desc: 'Abduction latérale jambe tendue, contrôle du bassin.',      level: 1, unilateral: true },
  { id: 'monwalk',    m: 'squat', desc: 'Marche latérale en position basse, tension constante.',     level: 2, photo: true },
  { id: 'hamslide',   m: 'squat', desc: 'Glissé au sol, descente lente, remontée contrôlée.',        level: 2 },
  { id: 'pulsesquat', m: 'squat', desc: 'Squat bas, micro-pulsions sans remonter.',                  level: 2 },
  { id: 'pulselunge', m: 'squat', desc: 'Fente basse, pulses en bas de la course.',                  level: 2 },
  { id: 'lungewall',  m: 'squat', desc: 'Fente arrière + drive genou vers le mur.',                  level: 3 },
  { id: 'runjump',    m: 'squat', desc: 'Saut unilatéral explosif, réception mono-appui.',           level: 3 },
];
