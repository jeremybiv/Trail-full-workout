...
export const UP: Exercise[] = [
  ...
  { id: 'pike',        m: 'press', desc: 'Fessiers hauts, pompe quasi-verticale.' },
  { id: 'plank',       m: 'plank', desc: 'Tête-talons alignés, respire lentement.', hold: true, photo: true },
  { id: 'sideplank',   m: 'plank', desc: 'Avant-bras, hanches hautes.', hold: true, unilateral: true },
  ...
  { id: 'bicycle',     m: 'twist', desc: 'Coude vers le genou opposé.' },
  ...
  { id: 'shouldertap', m: 'cdyn',  desc: "Planche, touche l'épaule opposée." },
  { id: 'flutter',     m: 'cdyn',  desc: 'Dos au sol, jambes tendues, battements alternatifs.', photo: true },
  { id: 'splitcrunch', m: 'cdyn',  desc: 'Jambes en ciseaux, crunch synchronisé.' },
  ...
  { id: 'birddog',     m: 'plank', desc: 'Planche, bras et jambe opposés tendus.' },
];
...
export const LG: Exercise[] = [
  ...
  { id: 'rlunge',     m: 'squat', desc: 'Pas arrière, descente contrôlée.' },
  { id: 'jumpsquat',  m: 'squat', desc: 'Explosivité, atterrissage souple.', photo: true },
  { id: 'calf',       m: 'calf',  desc: 'Pointes de pieds, descente lente.' },
  ...
  { id: 'swingdrive', m: 'cdyn',  desc: 'Montée genou + extension explosive, alterné.' },
  { id: 'pogo',       m: 'calf',  desc: 'Petits bonds rapides, réception sur les pointes.' },
  { id: 'highknee',   m: 'cdyn',  desc: 'Course sur place, genoux à hauteur de hanche.' },
  ...
  { id: 'clamshell',  m: 'squat', desc: 'Sur une jambe, ouvre la hanche en rotation externe.', unilateral: true },
  { id: 'janefonda',  m: 'squat', desc: 'Abduction latérale jambe tendue, contrôle du bassin.', unilateral: true },
  { id: 'monwalk',    m: 'squat', desc: 'Marche latérale en position basse, tension constante.', photo: true },
  { id: 'hamslide',   m: 'squat', desc: 'Glissé au sol, descente lente, remontée contrôlée.' },
  { id: 'pulsesquat', m: 'squat', desc: 'Squat bas, micro-pulsions sans remonter.' },
  { id: 'pulselunge', m: 'squat', desc: 'Fente basse, pulses en bas de la course.' },
  { id: 'lungewall',  m: 'squat', desc: 'Fente arrière + drive genou vers le mur.' },
  { id: 'runjump',    m: 'squat', desc: 'Saut unilatéral explosif, réception mono-appui.' },
];
